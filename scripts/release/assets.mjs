...
// Archive the final signed, stapled bundle; ditto preserves framework symlinks.
execFileSync("ditto", [
  "-c",
  "-k",
  "--sequesterRsrc",
  "--keepParent",
  ".build/packages/Freac-darwin-arm64/Freac.app",
  join(directory, `Freac-${metadata.tag}-arm64.zip`),
]);
