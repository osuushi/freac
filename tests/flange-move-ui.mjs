...
import { flangeMoveRoute } from "./ui-flange-move.mjs";
...
try {
  ...
  await flangeMoveRoute(page, name, app);
} catch (error) {
  await page?.screenshot({ path: `.cache/sketch-review/${name}-flange-move-failure.png` });
  console.log(
    await page?.evaluate(() => ({
